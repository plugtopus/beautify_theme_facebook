            ...
            theme: function (themeStr) {
                switch (themeStr.toLowerCase()) {
                    case "bootstrap":
                        ...
                        break;
                    case "color":
                        this.dialogs.buttons.ok = "<button class='ok btn btn-danger btn-sm' tabindex='1'>{{ok}}</button>";
                        this.dialogs.buttons.cancel = "<button class='cancel btn btn-default btn-sm' tabindex='2'>{{cancel}}</button>";
                        this.dialogs.input = "<input type='text' class='form-control'>";
                        break;
                    case "purecss":
